...
/**
 * Function to provide AuthConfig
 * @param configObject
 * @returns Provider
 */
export function provideAuthConfig(configObject: IAuthConfig): Provider{
    return {
        provide : AuthConfig,
        useFactory: ()=> new AuthConfig(configObject)
    }
}
...
export class AuthHttp {
    ...
    constructor(options: AuthConfig, @Inject(Http) private http: Http) {
